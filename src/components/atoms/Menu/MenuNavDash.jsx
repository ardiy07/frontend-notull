...
const MenuNavDash = ({active, label}) => {
    return (
        <div className={`${active} items-center justify-between w-full md:flex md:w-auto md:order-1" id="mobile-menu-2`}>
